...
const { PORT, baseURL } = require("./tests/browser-port.js");
...
module.exports = defineConfig({
  ...
  webServer: {
    ...
    command: "python3 scripts/build_manifest.py; build_status=$?; if [ \"$build_status\" -ne 0 ] && [ \"$build_status\" -ne 2 ]; then exit \"$build_status\"; fi; exec python3 -m http.server " + PORT + " --bind 127.0.0.1",
    env: {
      ...process.env,
