...
10. Keep difficulty and distractors plausible. **Plausibility floor:** every distractor must be wrong for a reason a knowledgeable-but-unprepared learner could believe — a real term or value from the same domain — never an absurd, joke, or obviously-out-of-domain option (e.g. "the employee's home address", "a guarantee of zero breaches"). Nonsense options collapse the effective choice set and hand away the answer.
